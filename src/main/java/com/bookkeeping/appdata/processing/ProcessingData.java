...
public class ProcessingData {
	...
	@Autowired
	private UserRecordMapper getRecordMapper;

	// 从数据库中获取数据，并处理返回给微信小程序的主页使用 
	public HomePageData getHomePageData(String tableName) {
		
		Date nowDate = new Date();
		String nowYear = String.format("%tY", nowDate);
		String nowMonth = String.format("%tm", nowDate);
		String nowDay = String.format("%td", nowDate);
		...
		System.out.println("yearCost:" + yearCost + " monthCost:" + monthCost + " dayCost:" + dayCost);
